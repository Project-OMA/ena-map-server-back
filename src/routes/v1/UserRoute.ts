...
routes.route('/').post(authorizeUser([TEACHER]), validators.userValidator.create, expressValidator, upload.single('file'), userController.create);
...
routes.route('/file').post(authorizeUser([TEACHER]), upload.single('tb_users'), userController.createByFile);
