...
routes.route('/include/users').post(authorizeUser([TEACHER]), validators.groupValidator.create, expressValidator, groupController.createWithUsers);
...
routes.route('/:id/include/users').put(authorizeUser([TEACHER]), validators.groupValidator.update, expressValidator, groupController.updateWithUsers);
